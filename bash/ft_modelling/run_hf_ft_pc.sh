#!/bin/bash -l
#SBATCH -J hf_ft_pc
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/ft_modelling/out_hf_ft_pc.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/ft_modelling/out_hf_ft_pc.err
#SBATCH -p gpu-H200
#SBATCH --ntasks=1
...
python3 "$REPO_ROOT/scripts/smiles/ml/ft_modelling_new_datasets.py" --modality hf --mode ft_pc --dataset all
