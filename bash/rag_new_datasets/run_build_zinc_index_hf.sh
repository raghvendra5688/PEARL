#!/bin/bash -l
# Submit after run_embed_zinc_hf.sh completes.
#SBATCH -J zinc_index_hf_new
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_build_index_hf.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_build_index_hf.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --mem=120000
#SBATCH -A H200
...
python3 "$REPO_ROOT/scripts/smiles/rag/build_zinc_index_new_datasets.py" --dataset all
