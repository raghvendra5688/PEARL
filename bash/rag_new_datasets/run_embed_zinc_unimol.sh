#!/bin/bash -l
#SBATCH -J zinc_embed_unimol_new
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_embed_zinc_unimol.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_embed_zinc_unimol.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --mem=120000
#SBATCH -A H200
...
python3 "$REPO_ROOT/scripts/unimol/rag/embed_zinc250k_unimol_new_datasets.py" --dataset all
