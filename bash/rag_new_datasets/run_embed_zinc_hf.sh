#!/bin/bash -l
#SBATCH -J zinc_embed_hf_new
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_embed_zinc_hf.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/rag_new_datasets/out_embed_zinc_hf.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --mem=120000
#SBATCH -A H200
...
python3 "$REPO_ROOT/scripts/smiles/rag/embed_zinc250k_new_datasets.py" --dataset all
