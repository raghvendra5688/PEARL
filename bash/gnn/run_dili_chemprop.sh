#!/bin/bash -l
#SBATCH -J dili_chemprop
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/gnn/chemprop/out_dili_chemprop.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/gnn/chemprop/out_dili_chemprop.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
...
CHEMPROP_GPU=0 python3 "$REPO_ROOT/scripts/gnn/chemprop_baseline.py" --dataset dili
