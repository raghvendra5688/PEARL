#!/bin/bash -l
#SBATCH -J half_life_gcn
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/gnn/gcn/out_half_life_gcn.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/gnn/gcn/out_half_life_gcn.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
...
python3 "$REPO_ROOT/scripts/gnn/gcn_baseline.py" --dataset half_life
