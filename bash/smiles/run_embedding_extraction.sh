#!/bin/bash -l
#SBATCH -J ft_embed_extract
#SBATCH -o out_ft_embed_extract.txt
#SBATCH -e out_ft_embed_extract.err
#SBATCH -p gpu-A100
#SBATCH --gres=gpu:1
#SBATCH --mem=10000
#SBATCH -A A100
...
python3 "$REPO_ROOT/scripts/smiles/finetuning/finetuned_model_embeddings.py"
