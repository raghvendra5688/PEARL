#!/bin/bash -l
#SBATCH -J dili_ft_wl
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/smiles/finetuning/out_dili_ft_wl.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/smiles/finetuning/out_dili_ft_wl.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --mem=140000
#SBATCH -A H200
...
python3 "$REPO_ROOT/scripts/smiles/finetuning/finetune_dili_wl.py"
