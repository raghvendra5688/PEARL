#!/bin/bash -l
#SBATCH -J caco2_ft_huber
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/smiles/finetuning/out_caco2_ft_huber.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/smiles/finetuning/out_caco2_ft_huber.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --mem=140000
#SBATCH -A H200
...
python3 "$REPO_ROOT/scripts/smiles/finetuning/finetune_caco2_huber.py"
