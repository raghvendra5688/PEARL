#!/bin/bash -l
#SBATCH -J half_life_pc_only
#SBATCH -o out_half_life_pc_only.log
#SBATCH -e out_half_life_pc_only.err
#SBATCH -p gpu-H200
#SBATCH --ntasks=1
...
python3 "$REPO_ROOT/scripts/smiles/ml/pc_only_modelling.py" --dataset half_life
