#!/bin/bash -l
#SBATCH -J unimol_clintox_fl
#SBATCH -o logs/out_unimol_clintox_fl.log
#SBATCH -e logs/out_unimol_clintox_fl.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python3 "$SCRIPT_DIR/finetune_unimol_clintox_fl.py"
