#!/bin/bash -l
#SBATCH -J unimol_clintox_wl
#SBATCH -o logs/out_unimol_clintox_wl.log
#SBATCH -e logs/out_unimol_clintox_wl.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python3 "$SCRIPT_DIR/finetune_unimol_clintox_wl.py"
