#!/bin/bash -l
#SBATCH -J unimol_herg_wl
#SBATCH -o /export/qcai-omics/Raghvendra/PEARL/logs/unimol/finetuning/out_unimol_herg_wl.log
#SBATCH -e /export/qcai-omics/Raghvendra/PEARL/logs/unimol/finetuning/out_unimol_herg_wl.err
#SBATCH -p gpu-H200
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python3 "$SCRIPT_DIR/finetune_unimol_herg_wl.py"
