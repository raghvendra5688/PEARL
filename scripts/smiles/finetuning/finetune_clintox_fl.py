...
TRAINING_DIR = REPO_ROOT / "models" / "lora_training" / "clintox"
...
def data_load():
    train_clintox=pd.read_csv(str(DATA_DIR / 'train_clean.csv'))
    val_clintox=pd.read_csv(str(DATA_DIR / 'valid_clean.csv'))
