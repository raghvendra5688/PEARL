...
RESULTS_DIR = REPO_ROOT / "results" / "lora_finetuning" / "bace"
MODELS_DIR = REPO_ROOT / "models" / "lora_finetuned" / "bace"
TRAINING_DIR = REPO_ROOT / "models" / "lora_training" / "bace"
...
def data_load():
    train_bace=pd.read_csv(str(DATA_DIR / 'train_clean.csv'))
    val_bace=pd.read_csv(str(DATA_DIR / 'valid_clean.csv'))
