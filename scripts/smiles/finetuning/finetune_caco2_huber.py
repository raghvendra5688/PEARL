...
# %% [markdown]
# ## Hyperparameter tuning using WandB -- CACO2 | HUBER Loss (regression)
...
RESULTS_DIR = REPO_ROOT / "results" / "lora_finetuning" / "caco2"
...
TRAINING_DIR = PEARL_EXTRAS / "lora_training" / "caco2"  # scratch per-trial checkpoints, not repo-tracked
...
sweep_config = {
"name": "CACO2_HUBER_Hyperparameter_Tuning",
"method": "bayes",
"metric": {
    "goal": "maximize",
    "name": "eval/r2"},
...
for key in MODEL_NAME_MAP.keys():
    ...
    save_path = str(PEARL_EXTRAS / "huber_loss_CACO2" / (key+"_LoRA_Finetuned")) + "/"
